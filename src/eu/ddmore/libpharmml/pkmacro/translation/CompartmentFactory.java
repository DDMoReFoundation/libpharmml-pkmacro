...
/**
 * Class for registering the compartments used in the current translation. Any compartment generated by a macro must be stored
 * within a unique instance of this class.
 * 
 * @author Florent Yvon
 */
class CompartmentFactory {
	 ...
	 * exists. An other possiblity is to use the method {@link #highestCompartmentId()} and increment it for
	 * generating the id of the new compartment.
	...
	/**
	 * Ges the highest compartment id stored within this factory.
	 * @return The highest compartment id stored within this factory as an {@link Integer}.
	 */
	...
	/**
	 * Gets the lowest compartment id available.
	 * @return The lowest compartment id aviable as an {@link Integer}.
	 */
